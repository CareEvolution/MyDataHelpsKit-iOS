...
public struct SurveyTaskQuery: PagedQuery {
    ...
    public init(statuses: Set<SurveyTaskStatus>? = nil, surveyID: Survey.ID? = nil, surveyNames: Set<String>? = nil, sortOrder: SurveyTaskQuery.SortOrder? = nil, limit: Int = defaultLimit, pageID: SurveyTaskResultPage.PageID? = nil) {
    ...
    public func page(after page: SurveyTaskResultPage) -> SurveyTaskQuery? {
        ...
        return SurveyTaskQuery(statuses: statuses, surveyID: surveyID, surveyNames: surveyNames, sortOrder: sortOrder, limit: limit, pageID: nextPageID)
    }
}

...
public extension ParticipantSession {
    ...
    /// - Parameter query: Specifies how to filter the providers.
    /// - Returns: An asynchronously-delivered array of `ExternalAccountProvider`, if successful. Throws a `MyDataHelpsError` if unsuccessful.
